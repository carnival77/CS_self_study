...
**구성 값이 선택되는 기본 파일**이다. **스프링 부트는 클래스 패스 어디서나 application.properties 파일을 선택할 수 있다.**
...
**액티브 프로파일이 dev이면 application-dev.properties 의 값이 application.properties 의 기본 구성을 대체**한다.
